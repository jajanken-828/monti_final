...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
            ...
            @if (Route::has('login'))
                <nav class="flex items-center justify-between gap-4">
                    ...
                    <div class="flex items-center gap-4">
                        <span class="text-gray-600 dark:text-gray-400 text-sm">Already have an account?</span>
                        <a
                            href="{{ route('login') }}"
            ...
            <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                <div class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-gray-800 shadow-[inset_0px_0px_0px_1px_rgba(37,99,235,0.1)] dark:shadow-[inset_0px_0px_0px_1px_rgba(59,130,246,0.2)] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                    <div class="mb-8">
                        ...
                        <p class="text-gray-600 dark:text-gray-400">Join Monti Textile and start your professional journey today</p>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <!-- SCM (Supply Chain Management) Button -->
                            <button type="button" id="scmBtn" class="role-btn selected" onclick="selectRole('scm')">
                                <div class="w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center mb-3">
                                    <svg class="w-6 h-6 text-blue-theme" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12c0 1.66-1 3-2.5 3s-2.5-1.34-2.5-3 1-3 2.5-3 2.5 1.34 2.5 3z" />
                                    </svg>
                                </div>
                                <span class="font-medium text-gray-900 dark:text-white">SCM Professional</span>
                                <span class="text-sm text-gray-600 dark:text-gray-400 mt-1">Supply Chain Management</span>
                            </button>

                            <!-- HRM (Human Resource Management) Button -->
                            <button type="button" id="hrmBtn" class="role-btn" onclick="selectRole('hrm')">
                                <div class="w-12 h-12 rounded-full bg-yellow-100 dark:bg-yellow-900 flex items-center justify-center mb-3">
                                    <svg class="w-6 h-6 text-yellow-theme" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" />
                                    </svg>
                                </div>
                                <span class="font-medium text-gray-900 dark:text-white">HRM Professional</span>
                                <span class="text-sm text-gray-600 dark:text-gray-400 mt-1">Human Resource Management</span>
                            </button>
                        </div>
                        <input type="hidden" name="role" id="role" value="scm">
                    </div>
                    ...
                    <form method="POST" action="{{ route('register.post') }}" class="space-y-6" id="registerForm">
                        ...
                        <input type="hidden" name="role" id="formRole" value="scm">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start">
                                ...
                                <label for="terms" class="ml-2 text-sm text-gray-700 dark:text-gray-300">
                                    I agree to the 
                                    <a href="#" class="text-blue-theme hover:underline">Terms of Service</a> 
                                    and 
                        ...
                        <p class="text-center text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <a href="{{ route('login') }}" class="font-medium text-blue-theme hover:underline">
                                Sign in
                            </a>
                        </p>
                    </form>
                ...
                <div class="bg-gradient-to-br from-blue-50 to-yellow-50 dark:from-blue-950 dark:to-gray-900 relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/376] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden">
                    ...
                    <div class="absolute top-8 left-8">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-gray-600 dark:text-gray-400">Employee Platform</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="absolute bottom-8 left-0 right-0 px-8">
                        <div class="text-center">
                            <div class="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-2" id="roleTitle">Start as SCM Professional</div>
                            <div class="flex justify-center gap-4 text-sm">
                                <div class="flex items-center gap-1">
                                    <div class="w-2 h-2 rounded-full bg-blue-theme"></div>
                                    <span class="text-gray-600 dark:text-gray-400" id="benefit1">Supply Chain Courses</span>
                                </div>
                                <div class="flex items-center gap-1">
                                    <div class="w-2 h-2 rounded-full bg-yellow-theme"></div>
                                    <span class="text-gray-600 dark:text-gray-400" id="benefit2">Logistics Training</span>
                                </div>
                                <div class="flex items-center gap-1">
                                    <div class="w-2 h-2 rounded-full bg-blue-theme"></div>
                                    <span class="text-gray-600 dark:text-gray-400" id="benefit3">Industry Certifications</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <footer class="mt-8 text-center text-gray-500 dark:text-gray-400 text-sm">
            <p>© 2026 iLearn Platform. All rights reserved.</p>
            <p class="mt-2">Join thousands of professionals worldwide</p>
        </footer>
        ...
        <script>
            function selectRole(role) {
                ...
                if (role === 'scm') {
                    scmBtn.classList.add('selected');
                    hrmBtn.classList.remove('selected');
                } else {
                    scmBtn.classList.remove('selected');
                    hrmBtn.classList.add('selected');
                }
                ...
                // Update button text
                const roleText = role === 'scm' ? 'SCM Professional' : 'HRM Professional';
                document.getElementById('roleText').textContent = roleText;
                
                // Update illustration and benefits
            ...
            function updateRoleContent(role) {
                ...
                if (role === 'scm') {
                    roleTitle.textContent = 'Start as SCM Professional';
                    benefit1.textContent = 'Supply Chain Courses';
                    benefit2.textContent = 'Logistics Training';
                    benefit3.textContent = 'Industry Certifications';
                } else {
                    roleTitle.textContent = 'Start as HRM Professional';
                    benefit1.textContent = 'HR Management Courses';
                    benefit2.textContent = 'Talent Development';
                    benefit3.textContent = 'HR Certifications';
                }
            }
