    ...
    <div class="sidebar bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col py-6 px-4 fixed h-full z-10" id="sidebar">
        ...
        <nav class="flex-1 space-y-1">
            ...
            <a href="{{ route('hrm.staff.attendance') }}" class="sidebar-item flex items-center space-x-3 py-3 px-4 rounded-xl text-gray-600 dark:text-gray-300 hover:text-blue-theme">
                ...
                <span class="sidebar-text font-medium">Time & Attendance</span>
            </a>
            ...
            <div class="card mt-8 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <select class="w-full bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option>Select employee...</option>
                            <option>John Dela Cruz (EMP-2023-001)</option>
                            <option>Maria Santos (EMP-2023-002)</option>
                            <option>Robert Garcia (EMP-2023-003)</option>
                            <option>Ana Perez (EMP-2023-004)</option>
                        </select>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Time In</label>
                        <input type="time" class="w-full bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div>
                ...
                <div class="mt-6">
                    ...
                    <textarea rows="2" class="w-full bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Add remarks for this time entry..."></textarea>
                </div>
                <div class="mt-6 flex justify-end">
                    <button class="px-6 py-2 bg-blue-theme hover:bg-blue-700 text-white rounded-lg font-medium">
