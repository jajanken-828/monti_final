...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
        ...
        <main class="flex-1 p-8 overflow-y-auto custom-scrollbar">
            ...
            <div class="card p-6">
                <div class="payroll-table-container">
                    <table class="w-full payroll-table">
                        <thead>
                            <tr>
                                ...
                                <th class="py-3 px-4 text-left">Allowances</th>
                        ...
                        <tbody>
                            ...
                            <tr class="department-section">
                                <td colspan="10" class="py-3 px-4 bg-gray-50 dark:bg-gray-700 font-bold text-gray-900 dark:text-white">
                            ...
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                ...
                                <td class="py-4 px-4">Weaving Operator</td>
                                <td class="py-4 px-4">
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-400">₱</span>
                                        <input type="text" value="18500" class="amount-input input-field pl-8" data-type="basic">
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-400">₱</span>
                                        <input type="text" value="1250" class="amount-input input-field pl-8 addition" data-type="overtime">
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-400">₱</span>
                                        <input type="text" value="500" class="amount-input input-field pl-8 addition" data-type="allowance">
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-400">₱</span>
                                        <input type="text" value="1875" class="amount-input input-field pl-8 deduction" data-type="deduction">
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <div class="net-pay">₱18,375</div>
                                </td>
                                <td class="py-4 px-4">
                            ...
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                ...
                                <td class="py-4 px-4">Spinning Technician</td>
                                <td class="py-4 px-4">
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-400">₱</span>
                                        <input type="text" value="21300" class="amount-input input-field pl-8" data-type="basic">
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-400">₱</span>
                                        <input type="text" value="0" class="amount-input input-field pl-8 addition" data-type="overtime">
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-400">₱</span>
                                        <input type="text" value="750" class="amount-input input-field pl-8 addition" data-type="allowance">
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-400">₱</span>
                                        <input type="text" value="2150" class="amount-input input-field pl-8 deduction" data-type="deduction">
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <div class="net-pay">₱19,900</div>
                                </td>
                                <td class="py-4 px-4">
                                    <span class="approval-status status-pending">Pending</span>
                                </td>
                            ...
                            <tr class="department-section">
                                <td colspan="10" class="py-3 px-4 bg-gray-50 dark:bg-gray-700 font-bold text-gray-900 dark:text-white">
                                    <i class="fas fa-check-circle mr-2"></i> Quality Control Department (42 Employees)
                                </td>
                            </tr>
                            ...
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                ...
                                <td class="py-4 px-4">
                                    <div class="flex items-center">
                                        <div class="w-8 h-8 rounded-full bg-purple-100 dark:bg-purple-900 flex items-center justify-center text-purple-600 dark:text-purple-300 font-medium text-sm mr-3">
                                            RG
                                        </div>
                                        <div>
                                            <div class="font-medium text-gray-900 dark:text-white">Robert Garcia</div>
                                            <div class="text-sm text-gray-500 dark:text-gray-400">EMP-2023-089</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <span class="px-2 py-1 bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-300 text-xs rounded-full">Quality Control</span>
                                </td>
                                <td class="py-4 px-4">QC Inspector</td>
                                <td class="py-4 px-4">
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-400">₱</span>
                                        <input type="text" value="16800" class="amount-input input-field pl-8" data-type="basic">
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-400">₱</span>
                                        <input type="text" value="800" class="amount-input input-field pl-8 addition" data-type="overtime">
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-400">₱</span>
                                        <input type="text" value="400" class="amount-input input-field pl-8 addition" data-type="allowance">
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-400">₱</span>
                                        <input type="text" value="1700" class="amount-input input-field pl-8 deduction" data-type="deduction">
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <div class="net-pay">₱16,300</div>
                                </td>
                                <td class="py-4 px-4">
                                    <span class="approval-status status-pending">Pending</span>
                                </td>
                            ...
                            <tr class="department-section">
                                <td colspan="10" class="py-3 px-4 bg-gray-50 dark:bg-gray-700 font-bold text-gray-900 dark:text-white">
                                    <i class="fas fa-tools mr-2"></i> Maintenance Department (38 Employees)
                                </td>
                            </tr>
                            ...
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                ...
                                <td class="py-4 px-4">
                                    <div class="flex items-center">
                                        <div class="w-8 h-8 rounded-full bg-yellow-100 dark:bg-yellow-900 flex items-center justify-center text-yellow-600 dark:text-yellow-300 font-medium text-sm mr-3">
                                            AL
                                        </div>
                                        <div>
                                            <div class="font-medium text-gray-900 dark:text-white">Anna Lopez</div>
                                            <div class="text-sm text-gray-500 dark:text-gray-400">EMP-2023-112</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <span class="px-2 py-1 bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-300 text-xs rounded-full">Maintenance</span>
                                </td>
                                <td class="py-4 px-4">Electrical Technician</td>
                                <td class="py-4 px-4">
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-400">₱</span>
                                        <input type="text" value="19500" class="amount-input input-field pl-8" data-type="basic">
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-400">₱</span>
                                        <input type="text" value="1500" class="amount-input input-field pl-8 addition" data-type="overtime">
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-400">₱</span>
                                        <input type="text" value="600" class="amount-input input-field pl-8 addition" data-type="allowance">
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-400">₱</span>
                                        <input type="text" value="1950" class="amount-input input-field pl-8 deduction" data-type="deduction">
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <div class="net-pay">₱19,650</div>
                                </td>
                                <td class="py-4 px-4">
                                    <span class="approval-status status-pending">Pending</span>
                                </td>
                            ...
                            <tr class="department-section">
                                <td colspan="10" class="py-3 px-4 bg-gray-50 dark:bg-gray-700 font-bold text-gray-900 dark:text-white">
                                    <i class="fas fa-warehouse mr-2"></i> Warehouse Department (30 Employees)
                                </td>
                            </tr>
                            ...
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                ...
                                <td class="py-4 px-4">
                                    <div class="flex items-center">
                                        <div class="w-8 h-8 rounded-full bg-red-100 dark:bg-red-900 flex items-center justify-center text-red-600 dark:text-red-300 font-medium text-sm mr-3">
                                            JP
                                        </div>
                                        <div>
                                            <div class="font-medium text-gray-900 dark:text-white">James Perez</div>
                                            <div class="text-sm text-gray-500 dark:text-gray-400">EMP-2023-156</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <span class="px-2 py-1 bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-300 text-xs rounded-full">Warehouse</span>
                                </td>
                                <td class="py-4 px-4">Forklift Operator</td>
                                <td class="py-4 px-4">
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-400">₱</span>
                                        <input type="text" value="15200" class="amount-input input-field pl-8" data-type="basic">
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-400">₱</span>
                                        <input type="text" value="900" class="amount-input input-field pl-8 addition" data-type="overtime">
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-400">₱</span>
                                        <input type="text" value="300" class="amount-input input-field pl-8 addition" data-type="allowance">
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <div class="relative">
                                        <span class="absolute left-3 top-2 text-gray-400">₱</span>
                                        <input type="text" value="1520" class="amount-input input-field pl-8 deduction" data-type="deduction">
                                    </div>
                                </td>
                                <td class="py-4 px-4">
                                    <div class="net-pay">₱14,880</div>
                                </td>
                                <td class="py-4 px-4">
                                    <span class="approval-status status-pending">Pending</span>
                                </td>
                            ...
                            <!-- Totals Row -->
                            <tr class="total-row">
                                <td class="py-4 px-4 font-bold" colspan="3">TOTALS (245 Employees)</td>
                                <td class="py-4 px-4"></td>
                                <td class="py-4 px-4 font-bold">₱720,500</td>
                                <td class="py-4 px-4 font-bold">₱45,750</td>
                                <td class="py-4 px-4 font-bold">₱24,500</td>
                                <td class="py-4 px-4 font-bold">₱127,538</td>
                                <td class="py-4 px-4 font-bold text-green-600 dark:text-green-400 text-xl">₱638,712</td>
                                <td class="py-4 px-4"></td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="p-6">
                ...
                <div class="bg-blue-50 dark:bg-blue-900 rounded-lg p-4 mb-6">
                    ...
                    <div class="flex justify-between mb-2">
                        ...
                        <span class="font-medium">₱638,712</span>
                    </div>
    ...
    <script>
        ...
        function calculateNetPay(row) {
            ...
            const overtime = parseFloat(row.querySelector('input[data-type="overtime"]').value) || 0;
            const allowance = parseFloat(row.querySelector('input[data-type="allowance"]').value) || 0;
            const deduction = parseFloat(row.querySelector('input[data-type="deduction"]').value) || 0;
            
            const netPay = basic + overtime + allowance - deduction;
            row.querySelector('.net-pay').textContent = `₱${netPay.toLocaleString('en-US', {minimumFractionDigits: 0})}`;
        }
