...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>iLearn - Modern Learning Platform</title>
    ...
    <body class="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
        ...
        <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
            <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                <div class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-gray-800 shadow-[inset_0px_0px_0px_1px_rgba(37,99,235,0.1)] dark:shadow-[inset_0px_0px_0px_1px_rgba(59,130,246,0.2)] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                    <h1 class="mb-1 font-medium text-2xl text-blue-theme">Welcome to Monti Textile</h1>
                    <p class="mb-2 text-gray-600 dark:text-gray-400">Transform your learning experience with our modern e-learning platform. <br>Access courses anytime, anywhere.</p>
                    ...
                    <div class="mb-4 lg:mb-6">
                        ...
                        <ul class="flex flex-col mb-4 lg:mb-6">
                            ...
                            <li class="flex items-center gap-4 py-2 relative before:border-l before:border-gray-200 dark:before:border-gray-700 before:bottom-1/2 before:top-0 before:left-[0.4rem] before:absolute">
                                ...
                                <span>
                                    Track progress with interactive
                                    <a href="#" class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-blue-theme ml-1">
                    ...
                    <div class="mb-6">
                        <h2 class="font-medium text-lg mb-3 text-blue-theme">Features</h2>
                    ...
                    {{-- <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <a href="{{ route('register') }}" class="inline-block bg-blue-theme hover:bg-blue-700 px-5 py-2 rounded-sm border border-blue-theme text-white text-sm leading-normal transition-colors">
                                Start Learning Free
                            </a>
                        </li>
                        <li>
                    ...
                    <div class="absolute top-8 left-8">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-gray-600 dark:text-gray-400">Platform</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="absolute inset-0 flex items-center justify-center">
                        <div class="relative w-64 h-64">
                            ...
                            <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                                <div class="w-40 h-32 bg-white dark:bg-gray-800 rounded-lg shadow-xl rotate-6 border-2 border-blue-100 dark:border-blue-900">
                                    <div class="absolute inset-0 p-4">
                                        ...
                                        <div class="h-2 bg-blue-300 dark:bg-blue-700 rounded mb-2 w-3/4"></div>
                                        <div class="h-2 bg-yellow-theme rounded mb-2 w-1/2"></div>
                                        <div class="h-2 bg-blue-200 dark:bg-blue-800 rounded mb-2"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="absolute top-8 left-12">
                                <div class="w-16 h-8 bg-yellow-theme rounded-t-lg"></div>
                                <div class="w-20 h-2 bg-yellow-600 mx-auto"></div>
                            </div>
                            
                            <!-- Progress Circle -->
                            <div class="absolute bottom-12 right-12">
                                <div class="w-20 h-20 rounded-full border-4 border-blue-200 dark:border-blue-800 flex items-center justify-center">
                                    <div class="w-16 h-16 rounded-full border-4 border-blue-theme border-t-transparent flex items-center justify-center">
                                        <span class="text-blue-theme font-bold">85%</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="absolute bottom-8 left-0 right-0 px-8">
                        <div class="flex justify-between">
                            <div class="text-center">
                                <div class="text-2xl font-bold text-blue-theme">500+</div>
                                <div class="text-sm text-gray-600 dark:text-gray-400">Courses</div>
                            </div>
                            <div class="text-center">
                                <div class="text-2xl font-bold text-yellow-theme">50K+</div>
                                <div class="text-sm text-gray-600 dark:text-gray-400">Students</div>
                            </div>
                            <div class="text-center">
                                <div class="text-2xl font-bold text-blue-theme">98%</div>
        ...
        <footer class="mt-8 text-center text-gray-500 dark:text-gray-400 text-sm">
            ...
            <p class="mt-2">Transform your learning journey with modern technology</p>
        </footer>
